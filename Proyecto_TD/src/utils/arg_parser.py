...
def parse_arguments():
    ...
    parser.add_argument("--mode", type=str, required=True, choices=["preprocess", "train", "evaluate", "generate_new_recipes", "test"], help="Execution mode")
    ...
    parser.add_argument("--model_type", type=str, choices=["pytorch", "transformers"], help="Type of model to use")
